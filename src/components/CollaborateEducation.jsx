...
export default function CollaborateEducation() {
  return (
    ...
    >
        <h1 className='font-acorn text-xl text-[rgb(2,90,78)] dark:text-[rgb(209,233,225)] md:text-2xl lg:text-3xl md:w-[85%] lg:w-[80%] pt-2'>
            I hold a Bachelor's degree in Computer Science from Notre Dame of Dadiangas University.
        </h1>
        <p className='text-[rgb(76,103,99)] dark:text-[rgb(176,200,191)] font-medium md:text-lg md:w-[85%] lg:w-[90%] pt-2 text-justify'> 
