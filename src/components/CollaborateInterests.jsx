...
export default function CollaborateInterests() {
  return (
    ...
    >
        <h1 className='font-acorn text-xl text-[rgb(2,90,78)] dark:text-[rgb(209,233,225)] md:text-2xl lg:text-3xl md:max-w-[70%] pt-2'>
            During my downtime from coding, I found fulfillment in weightlifting and photography. 
        </h1>
        <p className='text-[rgb(76,103,99)] dark:text-[rgb(176,200,191)] font-medium md:text-lg md:max-w-[70%] pt-2 text-justify'> 
