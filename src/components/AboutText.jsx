    ...
    <div className='max-w-[1240px] mx-auto p-8 flex flex-col lg:flex-row'>
        <div className= 'lg:flex lg:justify-between'>
            <div className='lg:max-w-[60%]'>
                <h1 className='font-acorn text-2xl text-[rgb(2,90,78)] dark:text-[rgb(209,233,225)] md:text-3xl lg:text-4xl'>I'm a Front-End Developer</h1>
                <h1 className='font-acorn text-2xl text-[rgb(2,90,78)] dark:text-[rgb(209,233,225)] md:text-3xl lg:text-4xl'>working remotely from the Philippines.</h1>
                <p className='pt-4 text-[rgb(76,103,99)] dark:text-[rgb(176,200,191)] font-medium md:text-lg text-justify'>
            ...
            <div className='flex justify-center lg:max-w-[40%] pt-6 pb-6 lg:py-0'>
                <img src={programming} alt="me" className='h-30 h-96'></img>
            </div>
        </div>
    </div>
  )
